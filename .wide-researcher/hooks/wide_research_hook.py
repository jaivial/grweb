...
by `installClaudeBundle()` with these placeholders:
  /root/.wide-researcher/venv/bin/python   — absolute path to ~/.wide-researcher/venv python
  /root/.npm/_npx/77091404085bd1d4/node_modules/wide-researcher/python       — absolute path to bundled python/ tree
  /var/www/grweb/.wide-researcher/config.json— absolute path to <project>/.wide-researcher/config.json
"""
...
PROJECT_CONFIG = r"/var/www/grweb/.wide-researcher/config.json"
VENV_PYTHON = r"/root/.wide-researcher/venv/bin/python"
PY_ROOT = r"/root/.npm/_npx/77091404085bd1d4/node_modules/wide-researcher/python"
