...
export function RulesSection(): JSX.Element {
  return (
    <section id="rules" className="min-h-screen py-24 px-4 bg-dark-surface">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 text-center">
          <div className="inline-block p-8 rounded-2xl bg-gradient-to-r from-red-accent/10 to-dark-red/10 border border-red-accent/30">
            <p className="text-gray-300 mb-2">
              How much does it cost?
            </p>
            <p className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-accent to-dark-red">
              0.50€ per ticket
            </p>
