...
export const InscripcionesSection: FC<InscripcionesSectionProps> = ({ className = '' }) => {
  ...
  if (showInstagramFallback) {
    return (
      ...
      >
        ...
        <GiSandsOfTime className="w-16 h-16 text-white opacity-100 mb-4" />
        <p className="text-center text-lg text-gray-300 mb-6 max-w-xl px-4" data-ui="inscripciones-instagram-fallback-text">
        ...
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" data-ui="instagram-icon">
  ...
  return (
    ...
    >
      ...
      >
        ¡Inscríbete ya en II GRStrength Cup!
      </h3>
      ...
      {preparada?.responsable === true ? (
        ...
        >
          Inscríbete
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-ui="arrow-icon">
        ...
        >
          Inscríbete
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-ui="external-link-icon">
