            ...
            <div className="space-y-4" data-ui="url-input-section">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-accent/50 focus:border-red-accent transition-all"
                  data-ui="url-input"
                />
              </div>
              <button
