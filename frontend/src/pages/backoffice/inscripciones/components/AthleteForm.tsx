...
export function AthleteForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6" data-ui="athlete-form">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2.5 bg-dark-base border rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-accent/50 ${errors.firstName ? 'border-red-500' : 'border-dark-border'}`}
            placeholder="Nombre"
          />
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2.5 bg-dark-base border rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-accent/50 ${errors.surname ? 'border-red-500' : 'border-dark-border'}`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2.5 bg-dark-base border rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-accent/50 ${errors.email ? 'border-red-500' : 'border-dark-border'}`}
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2.5 bg-dark-base border border-dark-border rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-accent/50"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1.5">Club</label>
          <input
            type="text"
            value={formData.club}
        ...
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1.5">Marca Total (kg)</label>
          <input
            type="number"
            step="0.1"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-1.5">Entrenador (opcional)</label>
        <input
          type="text"
